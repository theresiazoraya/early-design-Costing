<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="inventoryallowance1.aspx.cs" Inherits="PrototypePortalCosting.Rekomendasi" %>
        ...
        <section class="section">
            <div class="tables-wrapper">
                <form id="nonEditableForm">
                    ...
                    <h4>Summary Table</h4>
                    <table id="summaryTable" class="table table-striped table-bordered mt-2">
