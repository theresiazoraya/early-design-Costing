<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="DashboardProgressAffco.aspx.cs" Inherits="PrototypePortalCosting.Rekomendasi" %>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td id="totalRecommendations"></td>
                            <td id="implementedCount"></td>
                            <td id="implementedPercentage"></td>
                            <td id="inProgressCount"></td>
                            <td id="inProgressPercentage"></td>
                            <td id="notApplicableCount"></td>
