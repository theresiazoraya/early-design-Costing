<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="RateBySystem.aspx.cs" Inherits="PrototypePortalCosting.RateBySystem" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <main id="main" class="main">
        <div class="pagetitle">
            <h1>Rate By System</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                    <li class="breadcrumb-item">Process Cost</li>
                    <li class="breadcrumb-item active">Rate By System</li>
                </ol>
            </nav>
        </div>
