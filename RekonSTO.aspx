<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="RekonSTO.aspx.cs" Inherits="PrototypePortalCosting.Rekomendasi" %>
                ...
                <form id="editableForm">
                    <div class="row mb-3">
                        ...
                        <div class="text-center mt-4">
                            <button type="submit" class="btn btn-danger">Save to Draft</button>
