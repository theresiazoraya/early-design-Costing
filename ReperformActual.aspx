<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="ReperformActual.aspx.cs" Inherits="PrototypePortalCosting.ReperformActual" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <main id="main" class="main">
        <div class="pagetitle">
            <h1>Reperform Actual</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                    <li class="breadcrumb-item">Process Cost</li>
                    <li class="breadcrumb-item active">Reperform Actual</li>
                </ol>
            </nav>
        </div>
                    ...
                    <table class="table table-bordered">
                         <thead>
                            <tr>
                                ...
                                <th colspan="3" class="REPERFORMACTUAL">REPERFORM ACTUAL</th>
                                <th colspan="3" class="VARIANCE">VARIANCE</th>
                            </tr>
                            <tr>
                                <th class="ACTUAL">Cost (Idr)</th>
                                <th class="ACTUAL">Jam Kerja (Hour)</th>
                                <th class="ACTUAL">Rate (IDR/Hour)</th>
                                <th class="REPERFORMACTUAL">Cost (IDR)</th>
                                <th class="REPERFORMACTUAL">Jam Kerja (Hour)</th>
                                <th class="REPERFORMACTUAL">Rate (IDR/Hour)</th>
